...
class ProxyRTSPClient : public RTSPClientv2 {
public:
...
public:
	static ProxyServerMediaSession* createNew(BaseEnv& env,
...
protected:
	ProxyServerMediaSession(BaseEnv& env, GenericMediaServer* ourMediaServer,
...
private:
	...
	friend class ProxyServerMediaSubsession;
	friend class ProxyServerMediaSubsession2;
	void continueAfterDESCRIBE(char const* sdpDescription);
...
public:
	PresentationTimeSessionNormalizer(BaseEnv& env);
