...
#include "RTSPServerv2.hh" // For the optional "HandlerForREGISTERCommand" mini-server
#endif
#endif

class RTSPClientv2 : public Medium {
public:
	static RTSPClientv2* createNew(BaseEnv& env, char const* rtspURL,
	...
	typedef void (responseHandler)(RTSPClientv2* rtspClient,
...
//  "YYYYMMDDTHHMMSSZ" or "YYYYMMDDTHHMMSS.<frac>Z")
	...
	static Boolean lookupByName(BaseEnv& env,
		char const* sourceName,
		RTSPClientv2*& resultClient);
...
private:
	...
	static void responseHandlerForHTTP_GET(RTSPClientv2* rtspClient, int responseCode, char* responseString);
...
typedef void onRTSPClientCreationFunc(RTSPClientv2* newRTSPClient, Boolean requestStreamingOverTCP);

class HandlerServerForREGISTERCommand : public RTSPServerv2 {
public:
	static HandlerServerForREGISTERCommand* createNew(BaseEnv& env, onRTSPClientCreationFunc* creationFunc,
...
protected:
	HandlerServerForREGISTERCommand(BaseEnv& env, onRTSPClientCreationFunc* creationFunc, int ourSocketIPv4, int ourSocketIPv6, Port ourPort,
	...
	virtual RTSPClientv2* createNewRTSPClient(char const* rtspURL, int verbosityLevel, char const* applicationName,
