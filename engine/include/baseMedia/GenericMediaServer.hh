...
public:
	...
	void startRelayServerMediaSession(char const* streamName);

protected:
	GenericMediaServer(BaseEnv& env, int ourSocketIPv4, int ourSocketIPv6, Port ourPort, unsigned reclamationSeconds);
	...
	static int setUpOurSocket(BaseEnv& env, Port& ourPort, int domain);
...
public: // should be protected, but some old compilers complain otherwise
  // The state of a TCP connection used by a client:
	...
	protected:
		...
		BaseEnv& envir() { return fOurServer.envir(); }
		void closeSockets();
	...
	protected:
		...
		friend class RTSPServerv2; // needed to make some broken Windows compilers work; remove this in the future when we end support for Windows
