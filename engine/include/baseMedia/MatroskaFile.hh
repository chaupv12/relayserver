...
public:
  ...
  static void createNew(BaseEnv& env, char const* fileName, onCreationFunc* onCreation, void* onCreationClientData,
...
private:
  MatroskaFile(BaseEnv& env, char const* fileName, onCreationFunc* onCreation, void* onCreationClientData,
