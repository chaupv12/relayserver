...
public:
	static ServerMediaSession* createNew(BaseEnv& env, char const* streamName = NULL, char const* info = NULL, char const* description = NULL, Boolean isSSM = False, char const* miscSDPLines = NULL);

	static Boolean lookupByName(BaseEnv& env, char const* mediumName, ServerMediaSession*& resultSession);
...
protected:
	ServerMediaSession(BaseEnv& env, char const* streamName, char const* info, char const* description, Boolean isSSM, char const* miscSDPLines);
...
protected: // we're a virtual base class
	ServerMediaSubsession(BaseEnv& env);
