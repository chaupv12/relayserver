...
public:
	static RTCPInstance* createNew(BaseEnv& env, Groupsock* RTCPgs,
	...
	static Boolean lookupByName(BaseEnv& env, char const* instanceName, RTCPInstance*& resultInstance);
...
protected:
	RTCPInstance(BaseEnv& env, Groupsock* RTPgs, unsigned totSessionBW, unsigned char const* cname, RTPSink* sink, RTPSource* source, Boolean isSSMTransmitter, SRTPCryptographicContext* crypto);
