...
public:
	static MediaSession* createNew(BaseEnv& env, char const* sdpDescription);

	static Boolean lookupByName(BaseEnv& env, char const* sourceName, MediaSession*& resultSession);
...
public:
	...
	int connectionEndpointNameAddressFamily() const {
		return fConnectionEndpointNameAddressFamily == AF_UNSPEC ? parentSession().connectionEndpointNameAddressFamily() : fConnectionEndpointNameAddressFamily;
	}
...
protected:
	...
	BaseEnv& env() { return fParent.envir(); }
