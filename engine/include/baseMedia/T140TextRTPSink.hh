...
public:
	static T140TextRTPSink* createNew(BaseEnv& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat);

protected:
	T140TextRTPSink(BaseEnv& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat);
...
public:
	T140IdleFilter(BaseEnv& env, FramedSource* inputSource);
